...
module memory_RAM
    ...
    reg [width-1:0] RAM [0:2**depth_bits-1];
  	...
  	// Simple dual-port: independent read and write ports, simultaneous access supported.
  	// If read and write target the same address in the same cycle, read returns the OLD value (read-first).
